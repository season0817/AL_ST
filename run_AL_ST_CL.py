...
args={
    ...
    'optimizer_args':{'lr': 0.000005} #ag_news,dbpedia:0.000005
}
...
if __name__ == '__main__':
  ...
  # load dataset
    ...
    num_init_sizes=[15*num_classes]#1500
    for NUM_INIT_LB in num_init_sizes:
        #NUM_QUERY=int(NUM_INIT_LB/10)
        AL_NUM_QUERY=3*num_classes
        INIT_ST_NUM_QUERY=3*num_classes
        print("NUM_INIT_LB",NUM_INIT_LB)
        print("AL_NUM_QUERY",AL_NUM_QUERY)
        print("INIT_ST_NUM_QUERY",INIT_ST_NUM_QUERY)
        ...
        strategy=entropy_sampling.EntropySampling(X_tr,Y_tr,num_classes,idxs_lb,net,handler,args)
        ...
        for rd in range(1, NUM_ROUND+1):
            ...
            ST_NUM_QUERY=INIT_ST_NUM_QUERY
            ...
            strategy.save_oracle_samples(q_idxs)
            ...
            if len(np.unique(list(label_num_dict.values())))>1:
                ...
                #strategy.save_pseudo_samples(query_add_idxs)
                strategy.train_with_cl()
